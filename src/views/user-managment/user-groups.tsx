...
import UserGroupModal from "views/user-managment/modals/user-groups-modal";
...
const sampleData: DataRow[] = [
  { 
    ...
    manager: "John Smith",
    subRows: [
      { id: 101, groupName: "Super Admins", accessType: "admin", permissions: "Unrestricted", userCount: 2, manager: "John Smith" },
      { id: 102, groupName: "System Admins", accessType: "admin", permissions: "Unrestricted with audit logging", userCount: 3, manager: "John Smith" },
    ]
  },
  { 
    id: 2, 
    ...
    manager: "Jane Doe",
    subRows: [
      { id: 201, groupName: "Content Editors", accessType: "write", permissions: "Read_Write", userCount: 8, manager: "Jane Doe" },
      { id: 202, groupName: "Review Editors", accessType: "write", permissions: "Read + Write with approval required", userCount: 4, manager: "Jane Doe" },
    ]
  },
  { 
    id: 3, 
  ...
  { 
    ...
    groupName: "Marketing", 
    accessType: "write", 
    permissions: "Read + Write access with sales data", 
    userCount: 8, 
  ...
  { 
    ...
    groupName: "HR", 
    accessType: "write", 
    permissions: "Read_Write with personnel data access", 
    userCount: 6, 
    manager: "Michael Brown",
  },
];

// Props interface for the user groups component
...
export default function UserGroups({
  ...
  const columns = useMemo<ColumnDef<DataRow, unknown>[]>(() => [
    ...
    },
    {
      ...
      cell: ({ getValue }) => {
        ...
        // Determine styling based on permission type
        ...
        if (permissions.includes('Unrestricted')) {
          ...
          variant = 'filled';
        } else if (permissions.includes('Read_Write')) {
          color = theme.palette.warning.main;
          bgcolor = alpha(theme.palette.warning.main, 0.1);
          variant = 'filled';
        } else if (permissions.includes('Read Only')) {
  ...
  const handleExportCSV = () => {
    ...
    FileSaver.saveAs(blob, "user-groups-export.csv");
  };
    ...
    >
      ...
      >
        ...
        <Stack direction="row" justifyContent="space-between" width="100%">
          ...
          <UserGroupModal open={openModal} handleClose={handleClose}/>
        </Stack>
      </Box>
