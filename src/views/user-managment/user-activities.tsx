...
interface DataRow {
  id: number;
  name: string;
  feature: 'Initial Data Loaded' | 'Created Plan for Purchase Plan in IP' | 'Created Plan for Stock Out Prediction in IP';
  timestamp: string;
  ip_address: string;
  subRows?: DataRow[];
  [key: string]: any;
...
const sampleData: DataRow[] = [
  { 
    ...
    feature: 'Initial Data Loaded', 
    timestamp: '2023-07-15 14:23:45', 
    ip_address: '192.168.1.34' , 
    subRows: [
      { id: 101, name: "Super Admins", feature: 'Initial Data Loaded', timestamp: '2023-07-15 14:23:45', ip_address:'192.168.1.34'},
      { id: 102, name: "System Admins", feature: 'Initial Data Loaded', timestamp: '2023-07-15 14:23:45', ip_address:'192.168.1.34'},
    ]
  },
  { 
    id: 2, 
    name: "janedoe@demo.com", 
    feature:'Created Plan for Purchase Plan in IP', 
    timestamp: "2022-11-30 09:47:12", 
    ip_address: '10.0.0.123', 
    not_allowed: "Jane Doe",
    subRows: [
      { id: 201, name: "Content Editors", feature: 'Created Plan for Purchase Plan in IP', timestamp: "2022-11-30 09:47:12", ip_address: '10.0.0.123', },
      { id: 202, name: "Review Editors", feature: 'Created Plan for Purchase Plan in IP', timestamp: "2022-11-30 09:47:12", ip_address: '10.0.0.123', },
    ]
  },
  { 
    id: 3, 
    ...
    feature: 'Created Plan for Purchase Plan in IP', 
    timestamp: "2024-03-22 18:05:33", 
    ip_address: '172.16.254.1', 
    not_allowed: "David Johnson",
  },
  { 
    id: 4, 
    name: "davidjohnson@demo.com", 
    feature: 'Created Plan for Stock Out Prediction in IP', 
    timestamp: "2021-05-10 22:56:08", 
    ip_address: '203.0.113.45', 
    not_allowed: "Sarah Williams",
  },
  { 
    id: 5, 
    name: "michaelbrown@demo.com", 
    feature: 'Created Plan for Stock Out Prediction in IP', 
    timestamp: "2023-12-01 07:34:21", 
    ip_address: '198.51.100.78', 
    not_allowed: "Michael Brown",
  },
];

// Props interface for the user activities component
...
export default function UserActivities({
  ...
  const handleExportCSV = () => {
    ...
    FileSaver.saveAs(blob, "user-activities-export.csv");
  };
