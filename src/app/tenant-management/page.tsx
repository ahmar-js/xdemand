...
import BackNav from "views/user-managment/back-navigation";
import ManageTenantsModal from "views/user-managment/modals/manage-tenants-modal";
...
const sampleData: DataRow[] = [
  { 
    id: 1, 
    tenantName: "johnsmith@demo.com", 
    subRows: [
      { id: 101,  tenantName: "admin@gmail.com" },
      { id: 102,  tenantName: "admin@gmail.com" },
    ]
  },
  { 
    id: 2, 
    tenantName: "janedoe@demo.com", 
    subRows: [
      { id: 201,  tenantName: "admin@demo.com" },
      { id: 202,  tenantName: "admin@demo.com" },
    ]
  },
  { 
    id: 3, 
    tenantName: "sarahwilliams@demo.com", 
  },
  { 
    id: 4, 
    tenantName: "davidjohnson@demo.com", 
  },
  { 
    id: 5, 
    tenantName: "michaelbrown@demo.com", 
  },
];
    ...
    >
      ...
      >
        ...
        <Stack direction="row" justifyContent="space-between" width="100%">
          ...
          <ManageTenantsModal open={openModal} handleClose={handleClose}/>
        </Stack>
      </Box>
